        ...
        <div className="min-w-[600px]">
          ...
          <div className="grid grid-cols-8 border-b bg-gray-50">
            ...
            {weekDays.map((day, index) => (
              <div key={`weekday-${index}`} className="p-2 sm:p-3 text-center border-r last:border-r-0">
          ...
          <div className="max-h-[400px] sm:max-h-[600px] overflow-y-auto">
            {hours.map((hour) => (
              <div key={`hour-${hour}`} className="grid grid-cols-8 border-b last:border-b-0">
                {/* Час */}
                <div key={`time-label-${hour}`} className="p-2 sm:p-3 bg-gray-50 border-r text-xs sm:text-sm font-medium text-gray-600">
                  {hour}
                </div>
